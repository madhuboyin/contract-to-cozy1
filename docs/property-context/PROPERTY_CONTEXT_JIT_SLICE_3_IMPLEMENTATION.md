...
| Warranties | `Warranty`; `home-management.service.ts` | Provider, category, start and expiry dates; optional item link | Homeowner/property ownership; policy identity and date range | Inventoried; adapter deferred |
