...
- A4 health probe fix
- A3 OCR limiter migration + rate-limit verification
- B1 booking/session event wiring (first pass)
...
- [ ] Rate-limit verification gate closed
- [ ] Health probe gate closed (DB + Redis true checks)
- [ ] Schema parity gate closed
- [ ] Resolution replay gate closed
- [ ] `booking_initiated` live
