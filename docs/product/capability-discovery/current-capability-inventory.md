...
| coverage-intelligence | Coverage & Premium Review | ai | `/dashboard/coverage-intelligence` | Verified | DECIDE_COMPARE | BETA | REGULATED_COVERAGE | DECISION_RECORDED | Canonical | No | CATALOG_ONLY |
