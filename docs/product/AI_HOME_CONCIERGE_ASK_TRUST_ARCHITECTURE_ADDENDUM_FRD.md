...
| TA5 — Semantic answer relevance | Implemented | Default-on, independently controlled concept/semantic relevance validation runs after deterministic final-presentation validation, records bounded scores/reasons and latency, prevents unknown relevance from being counted as verified coverage, safely suppresses clear operation mismatches, and reports held-out direct-answer certification by operation |
