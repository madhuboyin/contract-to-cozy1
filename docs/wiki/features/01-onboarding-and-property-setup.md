...
- **Notes:**
  ...
  - For the established-owner branch, home type and the other home-basics are optional. The address tuple plus the journey trigger is sufficient to create the first Property; buyer and new-home branches retain their specialized requirements.
