...
export const ROUTE_DISPOSITION_RULES = [
  ...
  },
  {
    ...
    matches: matches(/^\/dashboard\/(actions|bookings|resolution-center|moving-concierge)(?:\/|$)|^\/dashboard\/properties\/\[id\]\/(action-plan|projects|claims|guidance|seller-prep|buyer-plan|new-home-plan|home-operations|renovations)(?:\/|$)/),
  },
  {
    id: 'home-record',
