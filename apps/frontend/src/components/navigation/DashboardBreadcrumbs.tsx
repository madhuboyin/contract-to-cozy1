...
const SEGMENT_LABELS: Record<string, string> = {
  ...
  edit: 'Edit',
  tools: 'Tools',
  'coverage-intelligence': 'Coverage & Premium Review',
  'coverage-options': 'Coverage Review Questions',
  'insurance-trend': 'Coverage Renewal Context',
  'risk-premium-optimizer': 'Coverage Loss-Risk Plan',
  book: 'Book',
