...
export function KnowledgeArticleCard({ article, featured = false, propertyId }: KnowledgeArticleCardProps) {
  ...
  if (featured) {
    return (
      <article className="grid gap-8 border-y border-slate-200/80 py-8 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-start lg:gap-10">
        ...
        {article.categories.length > 0 ? (
          <aside className="space-y-3 border-t border-slate-200/70 pt-5 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
