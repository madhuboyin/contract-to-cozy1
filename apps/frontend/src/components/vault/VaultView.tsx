...
import { getCategoryDisplayLabel } from '@/lib/config/serviceCategoryMapping';
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4">
      ...
      <div className="mb-8 flex items-center gap-2">
        ...
        <span className="text-xl font-bold text-slate-800">ContractToCozy</span>
      </div>
      ...
      <p className="mt-6 text-xs text-slate-400">
        ContractToCozy · Secure Property Sharing
      </p>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-slate-900 px-6 py-3 sm:px-10">
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">ContractToCozy</span>
      ...
      <footer className="bg-slate-900 px-6 py-6 text-center text-xs text-slate-500 sm:px-10">
        <p>
          This report was generated by ContractToCozy and reflects verified data as of{' '}
