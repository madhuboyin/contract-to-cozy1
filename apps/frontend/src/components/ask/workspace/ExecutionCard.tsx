...
import { Pin, PinOff, RefreshCw, Send, Sparkles, ThumbsDown, ThumbsUp, ChevronDown, ChevronUp } from 'lucide-react';
...
export function ExecutionFeedback({ executionId, propertyId, capabilities }: {
  executionId: string;
  propertyId?: string;
