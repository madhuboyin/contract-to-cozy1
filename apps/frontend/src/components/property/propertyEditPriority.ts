...
export const PROPERTY_PRIORITY_FIELDS: PropertyPriorityField[] = [
  ...
  { key: "hasFireExtinguisher", label: "fire extinguisher", tier: "P2", impactWeight: 68, sectionId: "safety", isFilled: (v) => v.hasFireExtinguisher !== null && v.hasFireExtinguisher !== undefined },
  { key: "hasSecuritySystem", label: "security system", tier: "P2", impactWeight: 67, sectionId: "safety", isFilled: (v) => v.hasSecuritySystem !== null && v.hasSecuritySystem !== undefined },
  { key: "hasDrainageIssues", label: "drainage detail", tier: "P2", impactWeight: 66, sectionId: "safety", isFilled: (v) => v.hasDrainageIssues !== null && v.hasDrainageIssues !== undefined },
