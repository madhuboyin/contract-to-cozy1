    ...
    <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-5">
      ...
      {hasProfileSnapshot ? (
        <div className="space-y-2">
          <p className="text-[11px] font-semibold tracking-normal text-gray-400">Your room</p>
      ...
      <div className="space-y-3">
        <p className="text-[11px] font-semibold tracking-normal text-gray-400">
      ...
      <p className="border-t border-gray-100 pt-3 text-[11px] text-gray-400">Small habits {'->'} fewer incidents and better claims readiness.</p>
    </div>
  );
}
