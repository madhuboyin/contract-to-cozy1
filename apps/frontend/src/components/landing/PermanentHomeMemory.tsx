...
const CATEGORIES = [
  ...
  { icon: Wrench, title: 'Repairs and maintenance', detail: 'Service history, regular upkeep, and replacement planning' },
  { icon: ReceiptText, title: 'Costs and improvements', detail: 'Project proof, expenses, and long-term value planning' },
...
export default function PermanentHomeMemory() {
  return <section className={`bg-slate-50 ${landingStyles.section}`}>
    <div className={landingStyles.container}>
      <div className="mx-auto max-w-2xl text-center"><p className={landingStyles.eyebrow}>How ContractToCozy gets smarter</p><h2 className={landingStyles.heading}>Your home builds a permanent, useful memory</h2><p className={`mt-3 ${landingStyles.body}`}>Documents, inspections, repairs, warranties, projects, provider visits, and major decisions stay tied to the property—so future guidance reflects the home&apos;s full history.</p></div>
