...
import { Camera, Calendar, LayoutDashboard, ShieldCheck, UserCircle2, Wrench } from 'lucide-react';
  ...
  const navigation = useMemo(
    () => [
      ...
      { name: 'Portfolio', href: '/providers/portfolio', icon: resolveProviderNavigationIcon('portfolio', Camera) },
      {
        ...
        icon: resolveProviderNavigationIcon('credentials', ShieldCheck),
      },
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-0.5 flex items-center gap-1.5">
                ...
                <span className="rounded bg-slate-100 px-1.5 py-0.5 text-[11px] font-semibold tracking-normal text-slate-600">
                  Dense Mode
                </span>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                {isAccountMenuOpen ? (
                  <div className="absolute right-0 mt-2 w-48 rounded-xl border border-slate-200 bg-white p-1.5 shadow-lg">
                    <Link href="/providers/credentials" className="block rounded-lg px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 active:bg-slate-100">
                      Credentials
                    </Link>
