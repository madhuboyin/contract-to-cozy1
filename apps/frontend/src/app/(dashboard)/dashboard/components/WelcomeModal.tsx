        ...
        <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center p-4">
            <Card className="w-full max-w-2xl shadow-2xl p-6 text-center">
                ...
                <CardContent className="space-y-6 pt-4">
                    ...
                    <div className="pt-4">
                        <Link href="/dashboard/properties/new" passHref legacyBehavior>
                            <Button size="lg" className="text-lg w-full font-bold">
...
const FeatureBlock = ({ icon: Icon, title, description }: any) => (
