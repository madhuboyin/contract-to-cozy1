...
export default function PortfolioIntelligenceStrip({
  ...
  return (
    <div className="mb-5 grid grid-cols-2 gap-3 md:grid-cols-5">
      ...
      >
        <p className="mb-1 text-[11px] font-semibold tracking-normal text-gray-400">Portfolio Value</p>
      ...
      >
        <p className="mb-1 text-[11px] font-semibold tracking-normal text-gray-400">Coverage Rate</p>
        <p
      ...
      >
        ...
        >
          <p className="mb-1 text-[11px] font-semibold tracking-normal text-gray-400">Coverage Gaps</p>
      ...
      >
        ...
        >
          <p className="mb-1 text-[11px] font-semibold tracking-normal text-gray-400">Missing Values</p>
          <p
            className={`text-2xl font-display font-bold ${
      ...
      >
        <p className="mb-1 text-[11px] font-semibold tracking-normal text-gray-400">Documents</p>
