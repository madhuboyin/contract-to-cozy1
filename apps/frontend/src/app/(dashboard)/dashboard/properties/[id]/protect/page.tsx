    ...
    <ErrorBoundary 
      fallback={
        <div className="mx-auto max-w-7xl p-6 text-center py-20">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Protection Engine Shielded</h1>
          <p className="text-slate-500 mt-2 max-w-sm mx-auto">
            We're securing your home's safety data. Please refresh the dashboard in a few moments.
          </p>
      ...
      <div className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6 lg:px-8 lg:pb-12">
        ...
        <MobileSection>
          ...
          <div className="space-y-4">
            ...
            {!protectionQuery.isLoading && urgentTasks.length === 0 && (
              <div className="pt-4 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all">
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-3 px-1">
                  ...
                  Likely Win for your home age
                </div>
                <WinCard 
                  title="Predictive Risk"
                  value="HVAC Lifespan Extension"
                  description={`Homes built around 2012 typically face a $3,000 evaporator coil failure. A $150 preventive flush can prevent this.`}
                  trust={{
                    confidenceLabel: "General",
                    freshnessLabel: "Synced now",
                    sourceLabel: "Local Service Benchmarks",
                    rationale: "Based on common failures for 12-15 year old systems in your climate."
                  }}
        ...
        <MobileSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href={selectedPropertyId ? `/dashboard/insurance?propertyId=${selectedPropertyId}` : '/dashboard/insurance'} className="block p-4 bg-white rounded-2xl border border-slate-200 hover:border-brand-300 transition-colors shadow-sm">
            ...
            <Link href={selectedPropertyId ? `/dashboard/warranties?propertyId=${selectedPropertyId}` : '/dashboard/warranties'} className="block p-4 bg-white rounded-2xl border border-slate-200 hover:border-brand-300 transition-colors shadow-sm">
              <div className="flex items-center gap-3">
