...
export default function Step1PropertyDetails({ step, onMarkComplete, isMarking }: Props) {
  return (
    <Card className="rounded-2xl">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-gray-600">
          Add baseline address and home details so insights, reminders, and reports can be personalized.
        </p>
