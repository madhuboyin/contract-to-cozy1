...
function EditionDetailPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      ...
      {/* Panel */}
      <div className="relative z-10 flex max-h-[90dvh] w-full max-w-2xl flex-col overflow-hidden rounded-t-3xl border border-white/70 bg-white/95 shadow-2xl backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-900/95 sm:rounded-2xl">
        {/* Header */}
...
export default function HomeGazetteClient() {
  ...
  return (
    <MobilePageContainer className="space-y-5 pb-[calc(8rem+env(safe-area-inset-bottom))] lg:max-w-7xl lg:px-8 lg:pb-10">
      ...
      <PropertyContextNotice context={currentEdition?.propertyContext} title="Gazette context" readOnly />
