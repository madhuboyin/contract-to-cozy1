...
// apps/frontend/src/app/(dashboard)/dashboard/home-renovation-risk-advisor/page.tsx
...
export default function HomeRenovationRiskAdvisorPage() {
  ...
  // Update URL when session changes (for shareability)
  React.useEffect(() => {
    if (!propertyId) return;
    const params = new URLSearchParams();
    params.set('propertyId', propertyId);
    if (currentSessionId) params.set('sessionId', currentSessionId);
    router.replace(`/dashboard/home-renovation-risk-advisor?${params.toString()}`, { scroll: false });
