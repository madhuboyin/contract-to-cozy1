        ...
        <>
          <div className="space-y-3 md:hidden">
            <MobileCard variant="compact" className="space-y-3 border-slate-200/80 bg-white shadow-sm">
              ...
              <div className="grid grid-cols-3 divide-x divide-slate-200 rounded-2xl border border-slate-200/90 bg-[linear-gradient(135deg,rgba(37,99,235,0.06),rgba(245,158,11,0.08),rgba(239,68,68,0.06))] overflow-hidden">
                <div className="px-2 py-2 sm:px-3 sm:py-2.5 text-center sm:text-left">
                  <p className="text-[10px] sm:text-[11px] tracking-normal text-indigo-700">Active</p>
                  <p className="text-base sm:text-lg font-semibold text-slate-900">{activePolicyCount}</p>
                </div>
                <div className="px-2 py-2 sm:px-3 sm:py-2.5 text-center sm:text-left">
                  <p className="text-[10px] sm:text-[11px] tracking-normal text-amber-700">Renewing</p>
                  <p className="text-base sm:text-lg font-semibold text-slate-900">{expiringSoonPolicyCount}</p>
                </div>
                <div className="px-2 py-2 sm:px-3 sm:py-2.5 text-center sm:text-left">
                  <p className="text-[10px] sm:text-[11px] tracking-normal text-rose-700">Expired</p>
                  <p className="text-base sm:text-lg font-semibold text-slate-900">{expiredPolicyCount}</p>
                </div>
              </div>
