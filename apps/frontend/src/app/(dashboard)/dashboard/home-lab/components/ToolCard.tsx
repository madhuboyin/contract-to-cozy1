...
export function ToolCard({
  ...
  return (
    ...
    >
      {isNew && (
        <span className="absolute right-4 top-4 rounded-full bg-brand-100 px-2 py-0.5 text-[11px] font-bold tracking-normal text-brand-700">
          New
        </span>
      )}
      ...
      <div className="mb-1 text-[11px] font-bold tracking-normal text-slate-400">
        {category}
      </div>
