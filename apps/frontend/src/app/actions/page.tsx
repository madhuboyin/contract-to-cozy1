  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        // TypeScript now knows propertyId is not null due to the early return above
      ...
      {suppressedActions.length > 0 && (
        <>
          ...
          <section className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              These actions are currently hidden from your main dashboard
              because they are already covered or in progress.
            </p>
