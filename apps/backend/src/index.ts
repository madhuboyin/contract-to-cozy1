...
import propertySaleCaseRoutes from './routes/propertySaleCase.routes';
...
import newHomeSetupRoutes from './routes/newHomeSetup.routes';
...
import ownershipCostsRoutes from './routes/ownershipCosts.routes';
import ownershipCostOperationsRoutes from './routes/ownershipCostOperations.routes';
...
import insuranceMarketContextRoutes from './routes/insuranceMarketContext.routes';
...
import homeReserveFundRoutes from './routes/homeReserveFund.routes';
...
import homeScoreShareRoutes from './routes/homeScoreShare.routes';
import propertyBriefRoutes from './propertyBrief/propertyBrief.routes';
import neighbourhoodTrustRoutes from './routes/neighbourhoodTrust.routes';
...
import quoteComparisonRoutes from './routes/quoteComparison.routes';
import homeEventRadarRoutes from './routes/homeEventRadar.routes';
import homeEventRadarAdminRoutes from './routes/homeEventRadarAdmin.routes';
...
import hiddenAssetSensitiveFactsRoutes from './routes/hiddenAssetSensitiveFacts.routes';
...
import propertyIntelligenceRoutes from './propertyIntelligence/propertyIntelligence.routes';
import propertyChangeRoutes from './propertyChanges/propertyChange.routes';
...
import adminHomeActionProactiveDeliveryRoutes from './routes/adminHomeActionProactiveDelivery.routes';
import adminCalibrationReleaseRoutes from './routes/adminCalibrationRelease.routes';
import adminCapabilityRoutes from './routes/adminCapability.routes';
import adminUserSupportRoutes from './routes/adminUserSupport.routes';
import adminAuditExplorerRoutes from './routes/adminAuditExplorer.routes';
import adminReviewModerationRoutes from './routes/adminReviewModeration.routes';
import adminProviderOpsRoutes from './routes/adminProviderOps.routes';
import adminBookingOpsRoutes from './routes/adminBookingOps.routes';
import adminHomeOperationsRoutes from './routes/adminHomeOperations.routes';
import adminIntelligenceRecomputeRoutes from './routes/adminIntelligenceRecompute.routes';
import adminSourceHealthRoutes from './routes/adminSourceHealth.routes';
import adminFeedbackQualityRoutes from './routes/adminFeedbackQuality.routes';
import adminCaseRoutes from './routes/adminCase.routes';
import adminWorkQueuesRoutes from './routes/adminWorkQueues.routes';
import adminPaymentOpsRoutes from './routes/adminPaymentOps.routes';
import adminPrivacyRequestsRoutes from './routes/adminPrivacyRequests.routes';
import adminContentGovernanceRoutes from './routes/adminContentGovernance.routes';
import savingsBenefitsAdminRoutes from './routes/savingsBenefitsAdmin.routes';
import adminAccessCertificationRoutes from './routes/adminAccessCertification.routes';
import adminSearchRoutes from './routes/adminSearch.routes';
import personalizationRoutes from './routes/personalization.routes';
import homeOperationsRoutes from './routes/homeOperations.routes';
...
import homeBriefingRoutes from './homeBriefing/homeBriefing.routes';
import materialSpecRoutes from './routes/materialSpec.routes';
import householdRoutes from './routes/household.routes';
import financingRoutes from './routes/financing.routes';
import diyRoutes from './routes/diy.routes';
import permitTrackerRoutes from './routes/permitTracker.routes';
import hoaComplianceRoutes from './routes/hoaCompliance.routes';
import providerCredentialRoutes from './routes/providerCredential.routes';
import inspectionHubRoutes from './routes/inspectionHub.routes';
import projectTrackerRoutes from './routes/projectTracker.routes';
import renovationCaseRoutes from './routes/renovationCase.routes';
...
import { validateSkillHandoffDefinitions } from './services/skills/skillHandoff';
import { validateSkillLineageRegistry } from './services/skills/skillLineageRegistry';
import { validateSkillDependencyRegistry } from './services/skills/skillDependencyRegistry';
...
app.use('/api', propertySaleCaseRoutes);
...
app.use('/api/new-home-setup', newHomeSetupRoutes);
...
app.use('/api', insuranceMarketContextRoutes);
...
app.use('/api', homeScoreShareRoutes);
app.use('/api', propertyBriefRoutes);
app.use('/api', neighbourhoodTrustRoutes);
app.use('/api', homeSavingsRoutes);
app.use('/api', ownershipCostsRoutes);
app.use('/api', ownershipCostOperationsRoutes);
app.use('/api', homeCapitalTimelineRoutes);
app.use('/api', homeReserveFundRoutes);
app.use('/api', negotiationShieldRoutes);
app.use('/api', homeEventRadarRoutes);
app.use('/api', homeEventRadarAdminRoutes);
...
app.use('/api', quoteComparisonRoutes);
...
app.use('/api', adminHomeActionProactiveDeliveryRoutes);
app.use('/api', adminCalibrationReleaseRoutes);
app.use('/api', adminCapabilityRoutes);
app.use('/api', adminUserSupportRoutes);
app.use('/api', adminAuditExplorerRoutes);
app.use('/api', adminReviewModerationRoutes);
app.use('/api', adminProviderOpsRoutes);
app.use('/api', adminBookingOpsRoutes);
...
app.use('/api', adminPaymentOpsRoutes);
app.use('/api', adminPrivacyRequestsRoutes);
app.use('/api', adminContentGovernanceRoutes);
app.use('/api', savingsBenefitsAdminRoutes);
app.use('/api', adminAccessCertificationRoutes);
app.use('/api', adminSearchRoutes);
app.use('/api', personalizationRoutes);
app.use('/api', homeOperationsRoutes);
...
app.use('/api', permitTrackerRoutes);
app.use('/api', hoaComplianceRoutes);
app.use('/api', providerCredentialRoutes);
app.use('/api', inspectionHubRoutes);
app.use('/api', projectTrackerRoutes);
app.use('/api', renovationCaseRoutes);
app.use('/api', gazetteRoutes);
app.use('/api', gazetteInternalRoutes);
app.use('/api', homeBriefingRoutes);
