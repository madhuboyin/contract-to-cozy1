...
export const createSpecBodySchema = z.object({
  ...
  supplierCheckedAt: z.string().datetime().optional().nullable(),
  supplierDiscontinued: z.boolean().optional(),
  successorProductUrl: z.string().url().max(500).optional().nullable(),
