...
export const REFINANCE_DISCLAIMER =
  ...
  'assumptions. A national benchmark is market context, not a personalized rate or offer. ' +
  'Modeled APR is not a lender disclosure; actual APR, savings, rates, and ' +
