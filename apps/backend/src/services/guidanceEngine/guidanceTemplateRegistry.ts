...
const ISSUE_TYPE_TO_TEMPLATE_KEY: Record<string, string> = {
  ...
  'compare_warranty_plans':    'warranty_purchase_journey',
  'understand_coverage':       'warranty_purchase_journey',
  'warranty_renewal':          'warranty_purchase_journey',
  'purchase_insurance':        'insurance_purchase_journey',
  'compare_rates':             'insurance_purchase_journey',
  'coverage_gap':              'insurance_purchase_journey',
  'policy_renewal':            'insurance_purchase_journey',
  'schedule_inspection':       'general_inspection_journey',
  'pre_purchase_inspection':   'general_inspection_journey',
  'annual_maintenance':        'general_inspection_journey',
  'post_repair_inspection':    'general_inspection_journey',
