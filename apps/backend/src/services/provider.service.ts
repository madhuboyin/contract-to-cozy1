  ...
  static async getProviderReviews(
    ...
    return {
      reviews: reviews.map((review) => ({
        ...
        verifiedOutcome: review.verifiedOutcome,
        timelinessVarianceDays: review.timelinessVarianceDays,
        priceVarianceCents: review.priceVarianceCents,
        journeyLinked: Boolean(review.guidanceJourneyId),
