...
const ROWS: readonly ObservationTuple[] = [
  ...
  ['002-expected', '002', 'MAINTENANCE_TASK_CREATE', .6406, true], ['002-competitor', '002', 'MAINTENANCE_STATUS', .6333, false],
  ['003-expected', '003', 'MAINTENANCE_TASK_COMPLETE', .121, true], ['003-competitor', '003', 'MAINTENANCE_TASK_UPDATE', .1206, false],
  ...
  ['007-expected', '007', 'SAVINGS_OPPORTUNITIES', .5479, true], ['007-competitor', '007', 'OWNERSHIP_COSTS', .4253, false],
  ['008-expected', '008', 'OWNERSHIP_COSTS', .6832, true], ['008-competitor', '008', 'SAVINGS_OPPORTUNITIES', .3379, false],
  ['009-expected', '009', 'INVENTORY_LOOKUP', .7246, true], ['009-competitor', '009', 'MAINTENANCE_TASK_COMPLETE', .3835, false],
  ['010-expected', '010', 'PROPERTY_SUMMARY', .5272, true], ['010-competitor', '010', 'MAINTENANCE_TASK_COMPLETE', .445, false],
  ['011-expected', '011', 'HOME_ACTIONS', .7333, true], ['011-competitor', '011', 'MAINTENANCE_TASK_UPDATE', .5052, false],
  ...
  ['014-expected', '014', 'REFINANCE_ANALYSIS', .6936, true], ['014-competitor', '014', 'PROPERTY_TAX_APPEAL_READINESS', .4586, false],
  ['015-expected', '015', 'REFINANCE_RATE_MONITOR', .5629, true], ['015-competitor', '015', 'HOME_DEADLINE_MONITOR', .3509, false],
  ['016-expected', '016', 'SELL_HOLD_RENT_ANALYSIS', .5358, true], ['016-competitor', '016', 'MAJOR_EVENT_ENTRY', .4525, false],
  ['017-expected', '017', 'HOUSEHOLD_INVITATION', .6546, true], ['017-competitor', '017', 'QUOTE_COMPARISON_CREATE', .0979, false],
  ['018-expected', '018', 'GUIDANCE_JOURNEY_CREATE', .5118, true], ['018-competitor', '018', 'RENOVATION_PERMIT_READINESS', .1182, false],
  ...
  ['024-expected', '024', 'RENOVATION_PERMIT_READINESS', .457, true], ['024-competitor', '024', 'REFINANCE_ANALYSIS', .1019, false],
  ['025-expected', '025', 'MAJOR_EVENT_ENTRY', .6136, true], ['025-competitor', '025', 'GUIDANCE_JOURNEY_CREATE', .5343, false],
  ['026-expected', '026', 'EMERGENCY_BOUNDARY', .1177, true], ['026-competitor', '026', 'SELL_HOLD_RENT_ANALYSIS', .0862, false],
  ...
  ['029-expected', '029', 'GROUNDED_GUIDANCE', .1587, true], ['029-competitor', '029', 'OUT_OF_SCOPE_BOUNDARY', .0623, false],
  ...
  ['033-expected', '033', 'HVAC_DECISION_ABANDON', .6142, true], ['033-competitor', '033', 'HVAC_DECISION_OUTCOME_REPORT', .4872, false],
  ...
  ['036-expected', '036', 'HOME_CHANGE_SUMMARY', .9096, true], ['036-competitor', '036', 'REFINANCE_ANALYSIS', .4377, false],
  ['037-expected', '037', 'HVAC_DECISION_OUTCOME_REPORT', .5325, true], ['037-competitor', '037', 'HVAC_DECISION_OUTCOME_VIEW', .6623, false],
  ['038-expected', '038', 'HVAC_DECISION_OUTCOME_VIEW', .5769, true], ['038-competitor', '038', 'HVAC_DECISION_OUTCOME_REPORT', .6486, false],
