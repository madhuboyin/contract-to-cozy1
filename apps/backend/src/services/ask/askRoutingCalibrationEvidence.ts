...
const ROWS: readonly ObservationTuple[] = [
  ...
  ['029-expected', '029', 'GROUNDED_GUIDANCE', .1587, true], ['029-competitor', '029', 'BUYER_COST_READINESS', .0981, false],
  ...
  ['043-expected', '043', 'BUYER_INSPECTION_REVIEW', .3538, true], ['043-competitor', '043', 'BUYER_COST_READINESS', .172, false],
  ...
  ['054-expected', '054', 'BUYER_NEGOTIATION_READINESS', .3093, true], ['054-competitor', '054', 'REPLACEMENT_GUIDANCE', .574, false],
  ['055-expected', '055', 'BUYER_COST_READINESS', .6776, true], ['055-competitor', '055', 'OWNERSHIP_COSTS', .7301, false],
  ['056-expected', '056', 'BUYER_FINDING_DISPOSITION', .3368, true], ['056-competitor', '056', 'GUIDANCE_JOURNEY_CREATE', .1435, false],
