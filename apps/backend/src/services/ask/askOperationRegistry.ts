...
export const ASK_OPERATION_DEFINITIONS: Readonly<Record<AskOperationId, AskOperationDefinition>> = Object.freeze({
  ...
  COVERAGE_COMPARISON_STATUS: definition('COVERAGE_COMPARISON_STATUS', 'STATUS_SUMMARY', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'coverage.comparison-status', ['SUMMARY', 'GROUPED_LIST', 'COMPARISON', 'BOUNDARY']),
  ...
  REFINANCE_ANALYSIS: definition('REFINANCE_ANALYSIS', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'refinance.analysis', ['SUMMARY', 'TABLE', 'COMPARISON', 'EVIDENCE', 'WORKFLOW_PROGRESS', 'MONITOR', 'BOUNDARY']),
  ...
  SELL_HOLD_RENT_ANALYSIS: definition('SELL_HOLD_RENT_ANALYSIS', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'sale-case.analysis', ['SUMMARY', 'GROUPED_LIST', 'TABLE', 'COMPARISON', 'EVIDENCE', 'BOUNDARY', 'DECISION_PROGRESS', 'WHY_NOW']),
  ...
  QUOTE_COMPARISON_REVIEW: definition('QUOTE_COMPARISON_REVIEW', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'quote-comparison.review', ['SUMMARY', 'GROUPED_LIST', 'TABLE', 'COMPARISON', 'EVIDENCE', 'BOUNDARY']),
  ...
  CAPITAL_RESERVE_PLAN: definition('CAPITAL_RESERVE_PLAN', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'capital-reserve.plan', ['SUMMARY', 'GROUPED_LIST', 'TABLE', 'TIMELINE', 'EVIDENCE', 'BOUNDARY']),
  ...
  RENOVATION_PERMIT_READINESS: definition('RENOVATION_PERMIT_READINESS', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'renovation-permit.readiness', ['SUMMARY', 'GROUPED_LIST', 'PROGRESS', 'EVIDENCE', 'BOUNDARY']),
  SELLER_PREP_CHECKLIST: definition('SELLER_PREP_CHECKLIST', 'DECISION_ANALYSIS', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'seller-prep.checklist', ['SUMMARY', 'PROGRESS', 'GROUPED_LIST', 'EVIDENCE', 'BOUNDARY']),
  ...
  BUYER_CLOSING_DAY_READINESS: definition('BUYER_CLOSING_DAY_READINESS', 'STATUS_SUMMARY', true, 'DETERMINISTIC', 'MATERIAL_DECISION', 'VIEWER', 'buyer.closing-day-readiness', ['SUMMARY', 'GROUPED_LIST', 'PROGRESS', 'BOUNDARY']),
