...
const EXAMPLES: Partial<Record<AskOperationId, string[]>> = {
  ...
  MAINTENANCE_STATUS: ['What maintenance is pending?', 'Show overdue upkeep and completed work'],
  INVENTORY_LOOKUP: ['What appliance details are missing?', 'What do you know about my refrigerator?'],
