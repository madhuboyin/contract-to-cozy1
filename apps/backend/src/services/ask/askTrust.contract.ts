...
const EXAMPLES: Partial<Record<AskOperationId, string[]>> = {
  PROPERTY_SUMMARY: [
    ...
    'Is the residence file complete and in good shape?',
  ],
  ...
  INVENTORY_LOOKUP: ['What appliance details are missing?', 'What do you know about my refrigerator?', 'Which home record items need attention or coverage?', 'Show my appliance inventory', 'Find the recorded information for my laundry dryer'],
  HOME_ACTIONS: ['What should I do next for this home?', 'What needs my attention first?'],
  QUOTE_COMPARISON_REVIEW: ['What details are missing from my contractor quote?', 'Compare these contractor bids', 'Which estimate is best?', 'Review my quotes and estimats', 'Lay the existing contractor offers side by side for review'],
  COVERAGE_GAPS: ['Which items have no warranty or insurance coverage?', 'Show gaps in my home protection', 'What is uncovered in my home?', 'Show missing coverage for my applicances', 'Which costly home items lack protection?', 'What expensive equipment is exposed without protection?'],
  ...
  OWNERSHIP_COSTS: ['Show my monthly home costs', 'Break down my annual ownership costs', 'What am I spending on this house?', 'Show my ownership costs by catagory', 'Where does our monthly housing spending go?'],
  ...
  QUOTE_COMPARISON_CREATE: ['Create a quote comparison workspace', 'Start a workspace to compare contractor quotes', 'Set up a new contractor-offer comparison'],
  ...
  MAINTENANCE_TASK_COMPLETE: ['Mark the gutter cleaning task complete', 'Complete my recorded maintenance task', 'Finish the recorded air-filter replacement job'],
  ...
  REFINANCE_ANALYSIS: ['Should I refinance now?', 'Is refinancing worth it now?', 'Should I refinance my morgage?', 'Would switching to a different mortgage improve my finances?', 'Could changing my present home loan make the financial numbers better?'],
  REFINANCE_RATE_MONITOR: ['Alert me when mortgage rates drop below 5 percent', 'Monitor mortgage rates for my refinance target', 'Watch borrowing costs and notify me when they cross my target percentage'],
  ...
  HVAC_DECISION_OUTCOME_VIEW: ['What was the outcome of my furnace decision?', 'Show what happened after the HVAC recommendation', 'Did we end up repairing or replacing the heater?', 'Show how the furnace choice concluded'],
