...
const jobs: Record<AskOperationId, string> = {
  ...
  INVENTORY_ITEM_CORRECT: 'correct the installed, purchased, or last-serviced date on a recorded inventory item',
  HOME_EVENT_CORRECT: 'correct the title or date of a recorded home timeline event',
  WARRANTY_CORRECT: 'correct the provider or expiry date on a recorded warranty you added',
...
const positives: Record<AskOperationId, readonly string[]> = {
  ...
  INVENTORY_ITEM_CORRECT: ['Correct the install date of this inventory item', 'The purchase date on my dishwasher record is wrong, fix it', 'Update the last serviced date for the water heater item', 'Change the installed date of this appliance'],
  HOME_EVENT_CORRECT: ['Correct the title of this timeline event', 'The date on my roof repair timeline event is wrong, fix the date', 'Change the name of this home event', 'Update the date of this timeline event'],
  WARRANTY_CORRECT: ['Correct the expiry date of this warranty', 'The provider on my HVAC warranty is wrong, fix the provider', 'Change the expiration date on my home warranty', 'Update the warranty provider name'],
  ROOM_RENAME: ['Rename this room', 'Change the name of the guest room', 'The name of my basement room is wrong, fix the room name', 'Update the room name'],
...
const negatives: Record<AskOperationId, readonly string[]> = {
  ...
  INVENTORY_ITEM_CORRECT: ['Show my home inventory', 'What do you know about my dishwasher?'],
  HOME_EVENT_CORRECT: ['Show my home timeline', 'What happened with my water heater?'],
  WARRANTY_CORRECT: ['Show my warranties', 'When does my HVAC warranty expire?'],
  ROOM_RENAME: ['Show my rooms', 'What is in the kitchen?'],
