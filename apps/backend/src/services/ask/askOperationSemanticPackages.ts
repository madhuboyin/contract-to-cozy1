...
const jobs: Record<AskOperationId, string> = {
  ...
  MAINTENANCE_FORECAST: 'see predicted upcoming maintenance for home systems',
  COVERAGE_GAPS: 'review insurance and warranty coverage gaps',
  COVERAGE_COMPARISON_STATUS: 'compare my current insurance policy against alternative quotes or terms',
  ...
  DOCUMENT_LOOKUP: 'look up uploaded documents',
  ...
  HOME_EVENT_RADAR_FEED: "review this property's own canonical Home Event Radar feed and monitored-event detail",
  ...
  BREAK_EVEN_ANALYSIS: 'see when owning this home breaks even, as appreciation catches up with cumulative ownership costs',
  NEIGHBORHOOD_CHANGE_FEED: 'review reviewed local changes around this home: planning, development, zoning, infrastructure, land use, flood maps and schools',
  PAST_HAZARD_EXPOSURE: "review this home's past hazard exposure and long-term hazard context from reviewed sources, with any effect the household recorded",
  APPLIANCE_FAILURE_RISK: "see which appliances and systems are nearing the end of their expected life, with failure risk by age, an estimated failure date and a replacement cost estimate",
  MAINTENANCE_BUDGET_FORECAST: "see how much to budget for home upkeep: a yearly total, a monthly average, a month-by-month forecast and a split by category",
  DO_NOTHING_SIMULATION: "review the latest Do-Nothing Simulator run: what putting off home upkeep for months could cost, the risk drivers, the biggest avoidable losses and the saved scenarios",
  PRICE_FINALIZATIONS_LIST: "review the prices and terms recorded in Price Finalization: each vendor's accepted price against the quote, the agreed scope, payment, warranty and timeline, and whether it was finalized or booked",
  HOA_COMPLIANCE_STATUS: "review this home's HOA records: the association and dues, approval requests with the association's recorded decision, and violations with cure deadlines and fines",
  GUIDANCE_JOURNEYS_LIST: "review the guided journeys under way on Guidance Overview: each issue's steps done, the next step and anything blocking it",
  PROPERTY_BRIEFS_LIST: "review this home's saved Property Briefs: each brief's purpose, snapshot date and sections, and which share links are still live",
  MATERIAL_SPECS_LIST: "look up the paint colours, tile, flooring, fixtures and suppliers recorded in this home's Material Specs",
  HOME_TIMELINE_EVENTS: "review this home's recorded history on the Home Timeline: repairs, improvements, purchases, inspections and claims, with how verified each event is",
  SERVICE_PRICE_CHECKS: "review the quote checks run in Service Price Radar for this home: each quoted price against the expected local range, with the verdict",
  PROJECT_TRACKER_PROJECTS: "review this home's contractor projects in Project Tracker: which are active, completed or cancelled, with contract, paid and remaining amounts",
  DIY_PROJECTS: "review this home's active DIY projects in planning or in progress, with how many required steps are done",
  HOME_UPGRADE_SCENARIOS: "review the upgrade options saved in this home's Home Upgrade Planner, grouped by system, with their estimated cost, savings, payback and any decision recorded",
  NEGOTIATION_SHIELD_CASES: "review this home's Negotiation Shield cases: the contractor quote, premium, claim settlement and urgency reviews prepared so far and where each one stands",
  PLANT_CARE_OUTLOOK: "review weather-aware care for this home's tracked plants and garden zones: what to change now or soon and why",
  HOME_DIGITAL_WILL: "review this home's continuity plan: how ready it is to hand off, what each section holds and who the trusted contacts are",
  HOME_HABITS: 'review the small household habits the Home Habit Coach suggests for this home, ranked, with why each was suggested',
  HOME_STATUS_BOARD: "review the condition of this home's recorded appliances and systems: what needs action, what to monitor, and what is in good shape",
  ...
  SELLER_PREP_CHECKLIST: 'review the seller-prep checklist for selling this home',
  SELLER_PREP_ITEM_DECISION: 'waive, pursue, reopen, or unpursue a seller-prep checklist item',
  INVENTORY_ITEM_CORRECT: 'fix a wrong date recorded on an inventory item',
  HOME_EVENT_CORRECT: 'correct the title or date of a recorded home timeline event',
  HOME_EVENT_VISIBILITY: 'change who can see a recorded home timeline event',
  HOME_EVENT_RADAR_STATE: 'save, unsave, dismiss, or restore one monitored Home Event Radar event for yourself',
  HOME_EVENT_RADAR_MARK_DONE: 'mark one monitored Home Event Radar event as handled after confirmation',
  HOME_EVENT_RADAR_FEEDBACK: 'send feedback on why one monitored Home Event Radar event is wrong or not useful',
  HOME_EVENT_RADAR_TASK: 'add or link a maintenance task for one recommended action on a monitored Home Event Radar event',
  HOME_EVENT_RADAR_PREFERENCES: 'change which Home Event Radar notifications reach you and how',
  WARRANTY_CORRECT: 'fix a wrong provider or date recorded on a warranty you added',
  ROOM_RENAME: 'rename a recorded room',
  ROOM_CREATE: 'add a new room to the home record',
  INVENTORY_ITEM_CREATE: 'add a new item to the home inventory',
  PROPERTY_CONTEXT_AREA_CAPTURE: 'fill in a missing home record detail for one area of the property summary',
  ...
  HVAC_SPECIALIST_ENGAGE: 'engage the HVAC Specialist agent on a flagged HVAC repair-or-replace home action',
  ...
  CAPTURE_EVIDENCE_CONFIRM: 'attach an already-uploaded document as evidence for something reported directly from conversation',
...
const positives: Record<AskOperationId, readonly string[]> = {
  ...
  HOME_EVENT_RADAR_FEED: ['Show my home event radar feed', 'What monitored events are happening near my home?', 'Anything going on around my house I should know about?', 'Show my radar matches'],
  ...
  DOCUMENT_LOOKUP: ['Show my documents', 'Which invoices, permits, and contracts have I uploaded?', 'List my documents by type', 'How many documents have I uploaded?', "Show the documents I've uploaded"],
  ...
  COVERAGE_COMPARISON_STATUS: ['Compare my current insurance policy against alternatives', 'Should I switch my home insurance?', 'Is my new policy equivalent to what I have now?', 'Am I better off shopping for new insurance?', "What's my coverage comparison status?", 'Should I keep or switch my insurance policy?'],
  ...
  HOME_EVENT_RADAR_FEEDBACK: ['Send feedback on this monitored event.', 'This radar event is not relevant to my home.'],
  HOME_EVENT_RADAR_TASK: ['Plan this recommended action from a monitored event.', 'Add a task for this radar recommended action.'],
  HOME_EVENT_RADAR_PREFERENCES: ['Change my Home Event Radar notification settings.', 'Turn on quiet hours for radar notifications.'],
  HOME_EVENT_CORRECT: ['Correct the title of this timeline event', 'Correct the date of this timeline event', 'The date recorded on this timeline event is wrong, fix it', 'Change the name of this home event'],
  WARRANTY_CORRECT: ['Correct the expiry date of this warranty', 'Correct the provider of this warranty', 'The date recorded on this warranty is wrong, fix it', 'The provider recorded on this warranty is wrong'],
  ROOM_RENAME: ['Rename this room', 'Rename the spare room', 'The name recorded for this room is wrong, fix it', 'Change the name of the guest room'],
  ROOM_CREATE: ['Add a room to my home record', 'Add a new room called Office', 'I need to add a basement room', 'Create a room for the guest bedroom'],
  INVENTORY_ITEM_CREATE: ['Add an item to my home inventory', 'Add a new appliance to my inventory', 'I need to add a dishwasher to my inventory', 'Create an inventory record for the new furnace'],
  PROPERTY_CONTEXT_AREA_CAPTURE: ['Fill in the missing details for the structure area', 'Complete the missing systems details in my home record', 'Answer the missing safety questions for my home', 'Fill in my home record gaps one area at a time'],
  ...
  BREAK_EVEN_ANALYSIS: ['At what point does this home break even?', 'Show my home break-even analysis', 'Is my home still costing more than it has gained in value?', 'When does appreciation catch up with what I have spent on this home?', 'Show my brake even projection'],
  NEIGHBORHOOD_CHANGE_FEED: ['Show my Around Your Home feed', 'Any new construction near my house?', 'Are there zoning changes near my home?', 'Is there road work planned near our street?', 'Whats changng around my home?'],
  PAST_HAZARD_EXPOSURE: ['Show my home risk replay', 'What past hazards has this home been exposed to?', 'Has this house been through any wildfires or floods?', 'Is my home in a flood zone?', 'Has my home evr been hit by a hurricane?'],
  APPLIANCE_FAILURE_RISK: ['Show my appliance oracle', 'Which appliances are likely to break down first?', 'What is the failure risk on my appliances?', 'Which of our systems are past their expected life?', 'Shwo my appliance oracle'],
  MAINTENANCE_BUDGET_FORECAST: ['Show my budget planner', 'How much should we budget for home maintenance this year?', 'What is our yearly upkeep budget?', 'Which months cost the most in upkeep?', 'Shwo my budget planner'],
  DO_NOTHING_SIMULATION: ['Show my do-nothing simulation', 'What is the cost of doing nothing on this house?', 'What happens if we keep putting things off?', 'What did the do-nothing analysis find?', 'Shwo my do-nothing simulation'],
  PRICE_FINALIZATIONS_LIST: ['Show my price finalizations', 'What price did we agree with the plumber?', 'Which vendor terms have we finalized?', 'What warranty did the roofer accept in writing?', 'Shwo my price finalizations'],
  HOA_COMPLIANCE_STATUS: ['Show my HOA records', 'Did the HOA approve our fence request?', 'Has the HOA sent us any violation notices?', 'When are our HOA dues due?', 'Shwo my HOA records'],
  GUIDANCE_JOURNEYS_LIST: ['Show my guided journeys', 'Show the guided journeys I have going', 'Where am I in my guided journey?', 'Open guidance overview', 'Shwo my guided journeys'],
  PROPERTY_BRIEFS_LIST: ['Open my saved property briefs', 'Which of our property briefs are still shared?', 'When does my brief share link expire?', 'Open my property brief', 'Shwo my property briefs'],
  MATERIAL_SPECS_LIST: ['Show my material specs', 'What paint colour did we use in the living room?', 'Which tile and flooring did we put in the kitchen?', 'Open material specs', 'Shwo my material specs'],
  HOME_TIMELINE_EVENTS: ['Open my home timeline', 'What does the history of our home include?', 'Which past repairs and improvements were logged?', 'Shwo my home timeline'],
  SERVICE_PRICE_CHECKS: ['Show my service price radar', 'Which of my price checks came in above the expected range?', 'What did my past quote checks say?', 'Open the price radar', 'Shwo my price radar'],
  PROJECT_TRACKER_PROJECTS: ['Show my project tracker', 'Which contractor projects are still in progress?', 'How much do we still owe our contractors?', 'Open my project tracker', 'Shwo my project tracker'],
  DIY_PROJECTS: ['Show my DIY projects', 'Which DIY projects am I in the middle of?', 'Which steps are left on my DIY projects?', 'Open the DIY project center', 'Shwo my diy projects'],
  HOME_UPGRADE_SCENARIOS: ['Show my upgrade planner options', 'What upgrade options have I saved for the house?', 'Which saved what-if scenarios have results ready?', 'Open my home digital twin', 'Shwo my upgrade planner'],
  NEGOTIATION_SHIELD_CASES: ['Show my negotiation shield cases', 'List the negotiation reviews I have prepared', 'Which of my negotiations have been analyzed?', 'Open negotiation shield', 'Shwo my negotiation shield'],
  PLANT_CARE_OUTLOOK: ['Show my plant care outlook', 'Do my plants need anything with this weather?', 'How should I care for my garden zones this week?', 'Open my plant advisor', 'Shwo my plant care'],
  HOME_DIGITAL_WILL: ['Show my home continuity plan', 'Is our house handoff plan ready if someone has to take over?', 'Who are the trusted contacts on my home plan?', 'Open my digital will', 'Shwo my continuity plan'],
  HOME_HABITS: ['Show my home habits', 'Which habits is the coach suggesting for our house?', 'Which home care habits should I pick up?', 'Open my habit coach', 'Shwo my home habbits'],
  HOME_STATUS_BOARD: ['Show my status board', 'Which of my appliances need attention?', 'How are my home systems holding up?', 'What is the condition of my appliances?', 'Shwo my status bord'],
  ...
  MAINTENANCE_FORECAST: ['What maintenance is coming up for my home?', 'Forecast my upcoming maintenance', 'When will my HVAC need service?', "Predict what maintenance I'll need next", 'What maintenance should I expect soon?'],
  ...
  HVAC_SPECIALIST_ENGAGE: ['Help me decide on the flagged furnace repair-or-replace home action', 'Open the HVAC repair-or-replace recommendation from my home actions', 'Why is the flagged heat pump action recommending a replacement?', 'Engage the specialist on my flagged furnace repair-or-replace action'],
  ...
  CAPTURE_EVIDENCE_CONFIRM: ['I uploaded the invoice for that roof replacement', 'Here is the receipt for the water heater install I just mentioned'],
...
const negatives: Record<AskOperationId, readonly string[]> = {
  ...
  HOME_EVENT_RADAR_FEED: ['Show my future home expenses and reserve plan', 'Query the broader intelligence envelope for my home'],
  ...
  DOCUMENT_LOOKUP: ['What extracted facts still need my review before they become official?', 'Show my appliance inventory', 'What information does this house still need?', 'What derived intelligence does this property have?'],
  ...
  MAINTENANCE_FORECAST: ['Show overdue maintenance', 'Create a new maintenance task', 'What should I do next for this home?'],
  ...
  HVAC_SPECIALIST_ENGAGE: ['Should I replace my refrigerator?', 'Start a brand-new HVAC repair-or-replace decision', 'What should I do next for this home?'],
  ...
  COVERAGE_COMPARISON_STATUS: ['Which items have no warranty or insurance coverage?', 'Compare these contractor bids'],
  ...
  BREAK_EVEN_ANALYSIS: ['When would refinancing my mortgage break even?', 'Show current ownership costs only', 'Should I sell, hold, or rent this home?', 'When will my house be paid off?'],
  NEIGHBORHOOD_CHANGE_FEED: ['What is happening near my home?', 'What changed in my home recently?', 'Do I need a permit for my deck?'],
  PAST_HAZARD_EXPOSURE: ['Storm near my home', 'My basement flooded, help me file a claim', 'Which insurance coverage do I need for floods?'],
  APPLIANCE_FAILURE_RISK: ['Which dishwasher brand should I buy?', 'Show my inventory', 'Should I repair or replace my water heater?'],
  MAINTENANCE_BUDGET_FORECAST: ['What are my monthly ownership costs?', 'What maintenance tasks are due?', 'How much will my renovation cost?'],
  DO_NOTHING_SIMULATION: ['Should I repair or replace my water heater?', 'What are my monthly ownership costs?', 'Run a new do-nothing simulation'],
  PRICE_FINALIZATIONS_LIST: ['Compare my service quotes', 'Is this plumber quote fair?', 'Book the plumber'],
  HOA_COMPLIANCE_STATUS: ['Do I need HOA approval to build a deck?', 'Is the HOA clear before closing?', 'Report an HOA violation'],
  GUIDANCE_JOURNEYS_LIST: ['Start a step-by-step plan for my water heater', 'What maintenance tasks are due?', 'What should I do next at home?'],
  PROPERTY_BRIEFS_LIST: ['Give me a brief summary of my home', 'Is my home profile complete?', 'Show my home timeline'],
  MATERIAL_SPECS_LIST: ['What paint colour should I choose for the bedroom?', 'Show my inventory', 'What documents do I have?'],
  HOME_TIMELINE_EVENTS: ['What changed at my home recently?', 'Has this house been through any wildfires or floods?', 'Log a repair on my timeline'],
  SERVICE_PRICE_CHECKS: ['Compare my service quotes', 'How much should a new roof cost?', 'Show my negotiation shield cases'],
  PROJECT_TRACKER_PROJECTS: ['Is my renovation ready for permits?', 'Show my DIY projects', 'Compare my service quotes'],
  DIY_PROJECTS: ['Can I fix this leaky faucet myself or should I hire a plumber?', 'What maintenance is due?', 'What renovation projects am I tracking?'],
  HOME_UPGRADE_SCENARIOS: ['Should I repair or replace my aging appliance?', 'What renovation projects am I tracking?', 'What maintenance is due?'],
  NEGOTIATION_SHIELD_CASES: ['What should I discuss with my agent about the inspection?', 'Compare my service quotes', 'What is the status of my insurance claim?'],
  PLANT_CARE_OUTLOOK: ['Which plants should I buy for my living room?', 'Is there severe weather near my home?', 'What maintenance is due?'],
  HOME_DIGITAL_WILL: ['Help me write my last will and testament', 'Show my household members', 'What home records do I have?'],
  HOME_HABITS: ['What maintenance is due?', 'What should I do next for my home?', 'Show my status board'],
  HOME_STATUS_BOARD: ['What maintenance is due?', 'What should I do next for my home?', 'Should I repair or replace my dishwasher?'],
  ...
  SELLER_PREP_CHECKLIST: ['Should I sell, hold, or rent this home?', 'Help me prepare to sell my home'],
  SELLER_PREP_ITEM_DECISION: ['Check my sale readiness', 'What is on my seller prep checklist?'],
  INVENTORY_ITEM_CORRECT: ['Show my home inventory', 'What do you know about my dishwasher?', 'When was my water heater last serviced?', 'When was my dishwasher installed?', 'When did I buy the refrigerator?', 'How old is my furnace?', 'Show the purchase date for my dishwasher'],
  HOME_EVENT_CORRECT: ['Show my home timeline', 'What happened with my water heater?', 'When was the roof replaced?', 'What happened with my roof last year?', 'What is the date of my last repair?'],
  HOME_EVENT_VISIBILITY: ['Who can see my home timeline?', 'Show my home timeline', 'Which events are private?'],
  HOME_EVENT_RADAR_STATE: ['Show my home event radar feed', 'What monitored events are happening near my home?'],
  HOME_EVENT_RADAR_MARK_DONE: ['Show my home event radar feed', 'Mark this maintenance task complete'],
  HOME_EVENT_RADAR_FEEDBACK: ['Show my home event radar feed', 'Give feedback on this Ask answer'],
  HOME_EVENT_RADAR_TASK: ['Show my home event radar feed', 'What maintenance is pending?'],
  HOME_EVENT_RADAR_PREFERENCES: ['Show my home event radar feed', 'Change my email notification settings'],
  WARRANTY_CORRECT: ['Show my warranties', 'When does my HVAC warranty expire?', 'What is the warranty expiration date for the roof?', 'Who is the provider on my home warranty?', 'Is my furnace under warranty?'],
  ROOM_RENAME: ['Show my rooms', 'What is in the kitchen?', 'How many rooms are in my house?', 'What is the name of the room with the water heater?'],
  ROOM_CREATE: ['Show my rooms', 'What is in the kitchen?', 'How many rooms are in my house?'],
  INVENTORY_ITEM_CREATE: ['Show my inventory', 'What appliances do I have?', 'How many items are in my inventory?'],
  PROPERTY_CONTEXT_AREA_CAPTURE: ['How complete is my home record?', 'What details are missing from my home record?', 'Show my property summary'],
  ...
  CAPTURE_EVIDENCE_CONFIRM: ['Show my home timeline', 'What is my roof type?'],
...
const answerPositives: Record<AskOperationId, readonly string[]> = {
  ...
  MAINTENANCE_FORECAST: ['A rule-based forecast predicts upcoming maintenance for recorded home systems, with a predicted date, priority, and reasoning.'],
  COVERAGE_GAPS: ['The coverage review identifies home items without recorded insurance or warranty protection.'],
  COVERAGE_COMPARISON_STATUS: ['The coverage comparison shows your current policy alongside any alternative quotes or policy terms on file, their equivalence status, and any recorded keep or switch decision.'],
  ...
  DOCUMENT_LOOKUP: ['Uploaded documents for this property are grouped by type with verification status and upload date.'],
  ...
  HOME_EVENT_RADAR_FEED: ["The property's monitored radar events are shown by severity and source, each with its own canonical detail."],
  ...
  BREAK_EVEN_ANALYSIS: ['The projected year when appreciation catches up with cumulative ownership costs is shown, with a conservative-to-optimistic range.'],
  NEIGHBORHOOD_CHANGE_FEED: ['Reviewed local changes near this home are listed by source, each with its possible relevance and the geography it matched.'],
  PAST_HAZARD_EXPOSURE: ['Past hazard records matched to this home are listed with any effect the household recorded, and long-term hazard context is shown separately.'],
  APPLIANCE_FAILURE_RISK: ['Your appliances are listed by urgency with their age against expected life, failure risk, an estimated failure date and a replacement estimate.'],
  MAINTENANCE_BUDGET_FORECAST: ['A yearly upkeep budget is estimated with a monthly average, month-by-month amounts and a split by category.'],
  DO_NOTHING_SIMULATION: ['Putting off upkeep for 12 months could cost an estimated range, driven by the listed risks, with the biggest avoidable losses and next steps.'],
  PRICE_FINALIZATIONS_LIST: ['Your finalized prices are listed by vendor with the accepted price, the original quote and the agreed terms.'],
  HOA_COMPLIANCE_STATUS: ['Your HOA approval requests are listed with what you reported and the association decision on record, and open violations show their cure deadline and fine.'],
  GUIDANCE_JOURNEYS_LIST: ['Your guided journeys are listed with how many steps are done, the next step and anything blocking it.'],
  PROPERTY_BRIEFS_LIST: ['Your saved property briefs are listed with each purpose, snapshot date and whether its share link is still live.'],
  MATERIAL_SPECS_LIST: ['The recorded paint colours, finishes and products are listed by category with their supplier.'],
  HOME_TIMELINE_EVENTS: ['The home\'s recorded history is listed by year with each event\'s date precision and verification.'],
  SERVICE_PRICE_CHECKS: ['Your recent quote checks are listed with each quoted price, the expected local range and whether it looks fair or high.'],
  PROJECT_TRACKER_PROJECTS: ['Your contractor projects are grouped as active, completed and cancelled with the contract amount, what was paid and what remains.'],
  DIY_PROJECTS: ['Your active DIY projects are listed newest first with how many required steps are done.'],
  HOME_UPGRADE_SCENARIOS: ['Your saved upgrade options are grouped by system with their estimated upfront cost, yearly savings and payback.'],
  NEGOTIATION_SHIELD_CASES: ['Your negotiation reviews are listed newest first with each scenario, status and when it was last analyzed.'],
  PLANT_CARE_OUTLOOK: ['Care changes for the tracked plants are listed by priority with the weather that triggered them, and garden zone plans are shown.', 'With heat or frost in the forecast, check the soil and move or cover the plants that need it soon.'],
  HOME_DIGITAL_WILL: ['The home continuity plan is shown with its handoff readiness, entry titles by section and the trusted contacts by role.'],
  HOME_HABITS: ['Suggested home habits are listed in ranked order, each with its cadence and why it was suggested.'],
  HOME_STATUS_BOARD: ['Recorded appliances and systems are grouped by condition: needs action, monitor, and in good shape, each with why.'],
  ...
  SELLER_PREP_CHECKLIST: ['Open seller-prep checklist items, with estimated cost ranges, are summarized by category.'],
  SELLER_PREP_ITEM_DECISION: ['The seller-prep checklist item decision is reviewed and applied to the shared checklist after confirmation.'],
  INVENTORY_ITEM_CORRECT: ['The selected inventory item has a corrected installed, purchased, or last-serviced date after confirmation.'],
  HOME_EVENT_CORRECT: ['The selected timeline event has a corrected title or date as a new revision after confirmation.'],
  HOME_EVENT_VISIBILITY: ['The selected timeline event is shared with a different audience after confirmation.'],
  HOME_EVENT_RADAR_STATE: ['The selected monitored event is saved, dismissed, or restored for you only.'],
  ...
  HOME_EVENT_RADAR_FEEDBACK: ['Feedback on the selected monitored event is recorded after confirmation.'],
  HOME_EVENT_RADAR_TASK: ['A maintenance task is added or linked for the selected radar action after confirmation.'],
  HOME_EVENT_RADAR_PREFERENCES: ['Your Home Event Radar notification settings are saved after confirmation.'],
  WARRANTY_CORRECT: ['The selected warranty has a corrected provider name or expiry date after confirmation.'],
  ROOM_RENAME: ['The selected room has a corrected name after confirmation.'],
  ROOM_CREATE: ['The new room is reviewed and added to the shared home record after confirmation.'],
  INVENTORY_ITEM_CREATE: ['The new item is reviewed and added to the shared home inventory after confirmation.'],
  PROPERTY_CONTEXT_AREA_CAPTURE: ['Each answer is reviewed and saved to the shared home record after confirmation.'],
...
const answerNegatives: Partial<Record<AskOperationId, readonly string[]>> = {
  ...
  MAINTENANCE_FORECAST: ['Pending, completed, overdue, and seasonal maintenance tasks are listed with checklist status and timing', 'The prioritized Home Actions list shows what needs attention first'],
  ...
  COVERAGE_COMPARISON_STATUS: ['The coverage review identifies home items without recorded insurance or warranty protection', 'The home record recently changed across several sections'],
  ...
  DOCUMENT_LOOKUP: ['Document-derived candidates awaiting review are listed without confirming a candidate', 'The home inventory shows appliance or equipment model, age, and service details'],
  ...
  HOME_EVENT_RADAR_FEED: ['The reserve plan shows future replacement windows and expected major expenses', 'A cross-domain normalized envelope of every registered producer is shown'],
  ...
  BREAK_EVEN_ANALYSIS: ['Monthly ownership expenses are summarized without any appreciation projection', 'A refinance break-even compares a new loan with the current mortgage'],
  NEIGHBORHOOD_CHANGE_FEED: ['Severe weather and air-quality events near the home are listed', 'Changes recorded inside the home are summarized'],
  PAST_HAZARD_EXPOSURE: ['Current severe weather alerts near the home are listed', 'A new insurance claim is drafted for recent damage'],
  APPLIANCE_FAILURE_RISK: ['Appliances and belongings in the inventory are listed', 'One appliance is compared for repair or replacement'],
  MAINTENANCE_BUDGET_FORECAST: ['Monthly ownership expenses are summarized', 'Maintenance tasks due this month are listed'],
  DO_NOTHING_SIMULATION: ['Monthly ownership expenses are summarized', 'One appliance is compared for repair or replacement'],
  PRICE_FINALIZATIONS_LIST: ['Several contractor proposals are compared side by side', 'A quoted price is checked against the expected local range'],
  HOA_COMPLIANCE_STATUS: ['Permit and HOA requirements for a planned renovation are checked', 'HOA and title items open before closing are listed'],
  GUIDANCE_JOURNEYS_LIST: ['A governed step-by-step home plan is ready to start', 'Maintenance tasks due this month are listed'],
  PROPERTY_BRIEFS_LIST: ['The home record summary identifies missing property details', 'Recorded home events are listed by year'],
  MATERIAL_SPECS_LIST: ['Appliances and belongings in the inventory are listed', 'Paint colour ideas are suggested for a room'],
  HOME_TIMELINE_EVENTS: ['Material changes from the last 30 days are summarized', 'Past hazard records matched to this home are listed'],
  SERVICE_PRICE_CHECKS: ['Several contractor proposals are compared side by side', 'A negotiation draft is prepared for the contractor'],
  PROJECT_TRACKER_PROJECTS: ['Permit and HOA requirements for a planned renovation are checked', 'Service quotes are compared side by side'],
  DIY_PROJECTS: ['A DIY or hire recommendation is given for one repair', 'Upcoming maintenance tasks are listed by due date'],
  HOME_UPGRADE_SCENARIOS: ['A repair or replace recommendation is given for one appliance', 'Renovation projects are listed with their permit status'],
  NEGOTIATION_SHIELD_CASES: ['Seller responses to inspection findings are listed for the closing', 'Service quotes are compared side by side'],
  PLANT_CARE_OUTLOOK: ['Room plant recommendations are generated for a room', 'Current severe weather alerts near the home are listed'],
  HOME_DIGITAL_WILL: ['Household members and their roles are listed', 'A legal will is drafted for the estate'],
  HOME_HABITS: ['Upcoming maintenance tasks are listed by due date', 'Recorded appliances are grouped by condition'],
  HOME_STATUS_BOARD: ['Upcoming maintenance tasks are listed by due date', 'A repair-or-replace recommendation is given for one appliance'],
  ...
  SELLER_PREP_CHECKLIST: ['Selling, holding, and renting options are compared using the recorded assumptions', 'A generic list of governed tools for a major home event is shown without checklist items'],
  SELLER_PREP_ITEM_DECISION: ['Open seller-prep checklist items are listed by category with estimated cost ranges'],
  INVENTORY_ITEM_CORRECT: ['Recorded inventory items are listed without changing any record'],
  HOME_EVENT_CORRECT: ['Recorded timeline events are listed without changing any record'],
  HOME_EVENT_VISIBILITY: ['Recorded timeline events are listed without changing who can see any event'],
  HOME_EVENT_RADAR_STATE: ['The monitored events near this home are listed without changing any event'],
  HOME_EVENT_RADAR_MARK_DONE: ['The monitored events near this home are listed without changing any event'],
  HOME_EVENT_RADAR_FEEDBACK: ['The monitored events near this home are listed without changing any event'],
  HOME_EVENT_RADAR_TASK: ['The monitored events near this home are listed without adding any task'],
  HOME_EVENT_RADAR_PREFERENCES: ['The monitored events near this home are listed without changing any setting'],
  WARRANTY_CORRECT: ['Recorded warranties are listed without changing any record'],
  ROOM_RENAME: ['Recorded rooms are listed without changing any record'],
  ROOM_CREATE: ['Recorded rooms are listed without adding any room'],
  INVENTORY_ITEM_CREATE: ['Recorded inventory items are listed without adding any item'],
  PROPERTY_CONTEXT_AREA_CAPTURE: ['The property summary lists what is missing without saving any answer'],
  ...
  HVAC_SPECIALIST_ENGAGE: ['A generic appliance replacement guide is shown', 'The Home Actions feed is re-ranked into a new priority order'],
  ...
  CAPTURE_EVIDENCE_CONFIRM: ['The described event is added to the canonical home timeline', 'The described warranty is ready to be saved to the canonical Living Home Record after confirmation.'],
