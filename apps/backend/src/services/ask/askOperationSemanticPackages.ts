...
const positives: Record<AskOperationId, readonly string[]> = {
  ...
  MAINTENANCE_STATUS: ['What maintenance is pending?', 'List pending maintenance tasks', 'Show overdue upkeep and completed work', 'Give me a rundown of household work remaining and finished'],
