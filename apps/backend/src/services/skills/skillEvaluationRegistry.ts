...
import { BREAK_EVEN_SKILL_EVALUATION } from './break-even';
import { NEIGHBORHOOD_CHANGE_RADAR_SKILL_EVALUATION } from './neighborhood-change-radar';
import { HOME_RISK_REPLAY_SKILL_EVALUATION } from './home-risk-replay';
import { STATUS_BOARD_SKILL_EVALUATION } from './status-board';
import { HOME_HABIT_COACH_SKILL_EVALUATION } from './home-habit-coach';
import { HOME_DIGITAL_WILL_SKILL_EVALUATION } from './home-digital-will';
import { PLANT_ADVISOR_SKILL_EVALUATION } from './plant-advisor';
import { NEGOTIATION_SHIELD_SKILL_EVALUATION } from './negotiation-shield';
import { HOME_DIGITAL_TWIN_SKILL_EVALUATION } from './home-digital-twin';
import { DIY_SKILL_EVALUATION } from './diy';
import { PROJECT_TRACKER_SKILL_EVALUATION } from './project-tracker';
import { SERVICE_PRICE_RADAR_SKILL_EVALUATION } from './service-price-radar';
import { HOME_TIMELINE_SKILL_EVALUATION } from './home-timeline';
import { MATERIAL_SPECS_SKILL_EVALUATION } from './material-specs';
import { PROPERTY_BRIEF_SKILL_EVALUATION } from './property-brief';
import { GUIDANCE_OVERVIEW_SKILL_EVALUATION } from './guidance-overview';
import { HOA_COMPLIANCE_SKILL_EVALUATION } from './hoa-compliance';
import { PRICE_FINALIZATION_SKILL_EVALUATION } from './price-finalization';
import { DO_NOTHING_SIMULATOR_SKILL_EVALUATION } from './do-nothing-simulator';
import { APPLIANCE_ORACLE_SKILL_EVALUATION } from './appliance-oracle';
import { BUDGET_PLANNER_SKILL_EVALUATION } from './budget-planner';
import { SELLER_PREPARATION_SKILL_EVALUATION } from './seller-preparation';
import { SELLER_PREP_SKILL_EVALUATION } from './seller-prep';
...
import { HOME_EVENT_RADAR_SKILL_EVALUATION } from './home-event-radar';
...
export const SKILL_EVALUATION_PACKAGES: Readonly<Record<string, SkillEvaluationPackage>> = Object.freeze({
  ...
  [HOME_EVENT_RADAR_SKILL_EVALUATION.id]: HOME_EVENT_RADAR_SKILL_EVALUATION,
  ...
  [BREAK_EVEN_SKILL_EVALUATION.id]: BREAK_EVEN_SKILL_EVALUATION,
  [NEIGHBORHOOD_CHANGE_RADAR_SKILL_EVALUATION.id]: NEIGHBORHOOD_CHANGE_RADAR_SKILL_EVALUATION,
  [HOME_RISK_REPLAY_SKILL_EVALUATION.id]: HOME_RISK_REPLAY_SKILL_EVALUATION,
  [STATUS_BOARD_SKILL_EVALUATION.id]: STATUS_BOARD_SKILL_EVALUATION,
  [HOME_HABIT_COACH_SKILL_EVALUATION.id]: HOME_HABIT_COACH_SKILL_EVALUATION,
  [HOME_DIGITAL_WILL_SKILL_EVALUATION.id]: HOME_DIGITAL_WILL_SKILL_EVALUATION,
  [PLANT_ADVISOR_SKILL_EVALUATION.id]: PLANT_ADVISOR_SKILL_EVALUATION,
  [NEGOTIATION_SHIELD_SKILL_EVALUATION.id]: NEGOTIATION_SHIELD_SKILL_EVALUATION,
  [HOME_DIGITAL_TWIN_SKILL_EVALUATION.id]: HOME_DIGITAL_TWIN_SKILL_EVALUATION,
  [DIY_SKILL_EVALUATION.id]: DIY_SKILL_EVALUATION,
  [PROJECT_TRACKER_SKILL_EVALUATION.id]: PROJECT_TRACKER_SKILL_EVALUATION,
  [SERVICE_PRICE_RADAR_SKILL_EVALUATION.id]: SERVICE_PRICE_RADAR_SKILL_EVALUATION,
  [HOME_TIMELINE_SKILL_EVALUATION.id]: HOME_TIMELINE_SKILL_EVALUATION,
  [MATERIAL_SPECS_SKILL_EVALUATION.id]: MATERIAL_SPECS_SKILL_EVALUATION,
  [PROPERTY_BRIEF_SKILL_EVALUATION.id]: PROPERTY_BRIEF_SKILL_EVALUATION,
  [GUIDANCE_OVERVIEW_SKILL_EVALUATION.id]: GUIDANCE_OVERVIEW_SKILL_EVALUATION,
  [HOA_COMPLIANCE_SKILL_EVALUATION.id]: HOA_COMPLIANCE_SKILL_EVALUATION,
  [PRICE_FINALIZATION_SKILL_EVALUATION.id]: PRICE_FINALIZATION_SKILL_EVALUATION,
  [DO_NOTHING_SIMULATOR_SKILL_EVALUATION.id]: DO_NOTHING_SIMULATOR_SKILL_EVALUATION,
  [APPLIANCE_ORACLE_SKILL_EVALUATION.id]: APPLIANCE_ORACLE_SKILL_EVALUATION,
  [BUDGET_PLANNER_SKILL_EVALUATION.id]: BUDGET_PLANNER_SKILL_EVALUATION,
  [SELLER_PREPARATION_SKILL_EVALUATION.id]: SELLER_PREPARATION_SKILL_EVALUATION,
  [SELLER_PREP_SKILL_EVALUATION.id]: SELLER_PREP_SKILL_EVALUATION,
  ...
  [propertyRecord.evaluationSuite]: evaluationPackage(propertyRecord, {
    routingCases: [
      ...
      { mode: 'EXACT', message: 'Correct the expiry date of this warranty', expectedOperationId: 'WARRANTY_CORRECT' },
      { mode: 'EXACT', message: 'Rename this room', expectedOperationId: 'ROOM_RENAME' },
    ],
