...
export const HOME_OPERATIONS_SKILL_EVALUATION = deepFreezeSkillPackage({
  ...
  routingCases: [
    ...
    { mode: 'PARAPHRASED', message: 'Show my home operations feed', expectedOperationId: 'HOME_ACTIONS' },
    { mode: 'COLLOQUIAL', message: "What's on my home to-do list?", expectedOperationId: 'HOME_ACTIONS' },
  ...
  expectedAdapters: [{ id: 'home-actions.feed', version: '1.0' }],
  ...
  expectedBlockTypes: ['BOUNDARY', 'CAPABILITY_LIST', 'EVIDENCE', 'GROUPED_LIST', 'PRIORITY_LIST', 'SUMMARY'],
  expectedCanonicalCalls: [{ id: 'home-actions.feed', version: '1.0' }],
