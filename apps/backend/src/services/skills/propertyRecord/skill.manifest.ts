...
export const PROPERTY_RECORD_SKILL = Object.freeze({
  ...
  allowedAdapters: [
    ...
    { id: 'home-event.visibility', version: '1.0' },
  ...
  consumerPolicy: [
    ...
    { consumer: 'CONCIERGE_HOME', operations: PROPERTY_RECORD_SKILL_OPERATIONS.filter((operationId) => operationId !== 'INVENTORY_ITEM_CORRECT' && operationId !== 'HOME_EVENT_CORRECT' && operationId !== 'HOME_EVENT_VISIBILITY' && operationId !== 'WARRANTY_CORRECT' && operationId !== 'ROOM_RENAME' && operationId !== 'ROOM_CREATE' && operationId !== 'INVENTORY_ITEM_CREATE' && operationId !== 'PROPERTY_CONTEXT_AREA_CAPTURE') },
  ...
  allowedResultBlocks: ['SUMMARY', 'GROUPED_LIST', 'TABLE', 'PROGRESS', 'EVIDENCE', 'CAPABILITY_LIST', 'CHANGE_SUMMARY', 'EMPTY_STATE', 'WORKFLOW_PROGRESS', 'LIMITATION'],
  dependencies: [
