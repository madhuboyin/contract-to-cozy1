...
const TOOL_DEFAULTS: Record<string, { label: string; defaultPct: number }> = {
  ...
  HOME_RISK_REPLAY:          { label: 'Past Hazard Exposure',        defaultPct: 0   },
  ...
  NEIGHBORHOOD_CHANGE_RADAR: { label: 'Around Your Home',            defaultPct: 0   },
  ...
  PROPERTY_BRIEF:            { label: 'Property Brief',              defaultPct: 0   },
