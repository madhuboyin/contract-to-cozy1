...
export const JOB_REGISTRY: JobRegistryEntry[] = [
  ...
  },
  {
    ...
    jobName: 'rentcast-property-enrichment-v3',
    triggerSupported: false,
    impact: 'HOMEOWNER_STATE',
    customerJob: 'STAY_AHEAD',
    defaultEnabledInBeta: true,
  ...
  {
    key: 'home-operations-reconciliation',
    name: 'Home Operations Reconciliation',
    description: 'Retries due canonical work synchronization failures and closes the reconciliation ledger when source and work state agree.',
    category: 'MAINTENANCE',
    schedule: 'Every 5 minutes',
    cronExpression: '*/5 * * * *',
    type: 'cron',
    queueName: 'cron-trigger-queue',
    jobName: 'home-operations-reconciliation',
    triggerSupported: true,
    impact: 'HOMEOWNER_STATE',
    customerJob: 'STAY_AHEAD',
    defaultEnabledInBeta: true,
  ...
  },
  {
    ...
    type: 'cron',
    queueName: 'cron-trigger-queue',
    jobName: 'expire-stale-work-item-candidates',
    triggerSupported: true,
    impact: 'HOMEOWNER_STATE',
    customerJob: 'STAY_AHEAD',
    defaultEnabledInBeta: true,
  ...
  {
    key: 'usgs-hazard-intelligence-ingest',
    name: 'USGS Hazard Intelligence Ingest',
    description:
      'Fetches reviewed USGS earthquake observations into the common Property Intelligence source, coverage, observation, match, and change ledger. Requires explicit reviewer and review-reference configuration.',
    category: 'HOME_INTELLIGENCE',
    schedule: 'Every 15 minutes',
    cronExpression: '7,22,37,52 * * * *',
    type: 'cron',
    queueName: 'cron-trigger-queue',
    jobName: 'usgs-hazard-intelligence-ingest',
    triggerSupported: true,
    impact: 'HOMEOWNER_STATE',
    customerJob: 'STAY_AHEAD',
    defaultEnabledInBeta: false,
  ...
  {
    key: 'purge-agent-runtime',
    name: 'Purge Agent Runtime',
    description: 'Deletes expired agent-runtime rows (AgentRun, AgentState, tool/LLM invocations, stale reservations) past their IPD-003 retention windows. Bounded metadata only; no homeowner data.',
    category: 'HOME_INTELLIGENCE',
    schedule: 'Daily at 03:40 UTC',
    cronExpression: '40 3 * * *',
    type: 'cron',
    queueName: 'cron-trigger-queue',
    jobName: 'purge-agent-runtime',
    triggerSupported: true,
    impact: 'DESTRUCTIVE',
    customerJob: 'PLATFORM_OPERATIONS',
    defaultEnabledInBeta: true,
