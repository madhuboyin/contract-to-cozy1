...
export const ADMIN_CAPABILITIES = [
  ...
  'CATALOG_REVIEW',
  'CATALOG_PUBLISH',
  'SAVINGS_BENEFITS_AUTHOR',
  'SAVINGS_BENEFITS_REVIEW',
  'SAVINGS_BENEFITS_PUBLISH',
...
export const ADMIN_CAPABILITY_RISK: Record<AdminCapability, AdminActionRiskLevel> = {
  ...
  // Material-financial content (benefit programs, eligibility claims,
  // dollar estimates) — one tier stricter than general content at each step.
  SAVINGS_BENEFITS_AUTHOR: 'MEDIUM',
  SAVINGS_BENEFITS_REVIEW: 'HIGH',
  SAVINGS_BENEFITS_PUBLISH: 'HIGH',
...
export const ADMIN_PERSONA_BUNDLES: Record<string, readonly AdminCapability[]> = {
  ...
  SAVINGS_BENEFITS_AUTHOR: ['SAVINGS_BENEFITS_AUTHOR'],
  SAVINGS_BENEFITS_REVIEWER: ['SAVINGS_BENEFITS_REVIEW'],
  SAVINGS_BENEFITS_PUBLISHER: ['SAVINGS_BENEFITS_PUBLISH'],
