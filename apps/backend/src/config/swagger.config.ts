...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Budget Forecaster', description: 'Budget forecasting' },
      { name: 'Appliance Oracle', description: 'Appliance replacement predictions' },
      { name: 'Emergency', description: 'Emergency troubleshooting' },
