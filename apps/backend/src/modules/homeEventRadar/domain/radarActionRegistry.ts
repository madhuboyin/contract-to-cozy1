...
export const RADAR_ACTION_DEFINITIONS: readonly RadarActionDefinition[] = [
  ...
  reviewedAction({ code: 'COMPARE_PROVIDERS', labelTemplate: 'Compare utility providers or rate plans', eventFamilies: ['utility'], minimumImpact: 'watch', minimumConfidence: 'medium', destination: INFORMATIONAL, requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'user_attestation', safetyClassification: 'financial_review' }),
  reviewedAction({ code: 'DOCUMENT_DAMAGE', labelTemplate: 'If your home was affected, document damage and keep receipts', eventFamilies: ['disaster'], minimumImpact: 'watch', minimumConfidence: 'low', destination: internal('documents', '/dashboard/documents', 'document_vault', 'Upload damage documentation', { action: 'upload' }), requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'downstream_capability', safetyClassification: 'financial_review', taskOperations: ALL_TASK_OPERATIONS }),
  ...
  reviewedAction({ code: 'GET_QUOTES', labelTemplate: 'Review insurance coverage questions', eventFamilies: ['insurance'], minimumImpact: 'watch', minimumConfidence: 'medium', destination: internal('coverage-intelligence', '/dashboard/properties/[id]/tools/coverage-intelligence?stage=questions', 'coverage_review', 'Review coverage questions'), requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'downstream_capability', safetyClassification: 'financial_review' }),
  ...
  reviewedAction({ code: 'PREPARE_APPEAL', labelTemplate: 'Confirm the official filing window before preparing appeal evidence', eventFamilies: ['tax'], minimumImpact: 'watch', minimumConfidence: 'medium', destination: internal('property-tax', '/dashboard/properties/[id]/tools/property-tax?stage=appeal'), requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'downstream_capability', safetyClassification: 'financial_review' }),
  ...
  reviewedAction({ code: 'REVIEW_ASSESSMENT', labelTemplate: 'Review the new property-tax assessment for accuracy', eventFamilies: ['tax'], minimumImpact: 'watch', minimumConfidence: 'medium', destination: internal('property-tax', '/dashboard/properties/[id]/tools/property-tax?stage=changes'), requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'downstream_capability', safetyClassification: 'financial_review' }),
