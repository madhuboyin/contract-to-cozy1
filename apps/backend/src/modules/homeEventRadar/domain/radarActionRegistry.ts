...
export const RADAR_ACTION_DEFINITIONS: readonly RadarActionDefinition[] = [
  ...
  reviewedAction({ code: 'PREPARE_APPEAL', labelTemplate: 'Review property-tax appeal readiness', eventFamilies: ['tax'], minimumImpact: 'watch', minimumConfidence: 'medium', destination: internal('property-tax', '/dashboard/properties/[id]/tools/property-tax?mode=appeal'), requiredContext: GENERAL_CONTEXT, responsibilityApplicability: 'not_applicable', completionEvidence: 'downstream_capability', safetyClassification: 'financial_review' }),
