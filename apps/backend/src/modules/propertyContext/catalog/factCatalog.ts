...
export const PROPERTY_FACT_CATALOG = [
  ...
  { key: 'systems.hasCooling', scope: 'SYSTEMS', canonicalOwner: 'Property.coolingType and InventoryItem', correctionPath: propertyPath('systems'), writable: true },
  ...
  { key: 'financial.financingProfile', scope: 'FINANCIAL', canonicalOwner: 'PropertyFinancingProfile', correctionPath: '/dashboard/properties/:propertyId/tools/financing/profile', writable: true },
  { key: 'financial.currentMortgage', scope: 'FINANCIAL', canonicalOwner: 'PropertyFinancingProfile', correctionPath: '/dashboard/properties/:propertyId/tools/financing/profile', writable: true },
