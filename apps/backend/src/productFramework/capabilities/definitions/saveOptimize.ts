...
export const SAVE_OPTIMIZE_CAPABILITIES = buildCapabilityDefinitions(([
  ...
  ['coverage-intelligence', 'Coverage Intelligence', 'Identify and evaluate protection gaps.', '/dashboard/coverage-intelligence', 'COVERAGE_INTELLIGENCE', 'ACTIVE', 'REGULATED_COVERAGE', 'CATALOG_ONLY'],
  ['coverage-options', 'Coverage Options', 'Compare options for identified coverage gaps.', '/dashboard/properties/[id]/tools/coverage-options', 'COVERAGE_OPTIONS', 'ACTIVE', 'REGULATED_COVERAGE', 'CONTEXTUAL'],
  ...
  ['insurance-trend', 'Insurance Trend', 'Monitor premium pressure and renewal risk.', '/dashboard/properties/[id]/tools/insurance-trend', 'INSURANCE_TREND', 'BETA', 'REGULATED_COVERAGE', 'CONTEXTUAL'],
  ...
  ['risk-premium-optimizer', 'Risk Optimizer', 'Review risk reduction and premium pressure.', '/dashboard/risk-premium-optimizer', 'RISK_PREMIUM_OPTIMIZER', 'ACTIVE', 'REGULATED_COVERAGE', 'CATALOG_ONLY'],
