...
export const PROTECT_MONITOR_CAPABILITIES = buildCapabilityDefinitions(([
  ...
  ['home-digital-twin', 'Home Digital Twin', 'Explore a living model of home systems and risks.', '/dashboard/properties/[id]/tools/home-digital-twin', 'HOME_DIGITAL_TWIN', 'ACTIVE', 'LOW_CONSEQUENCE', 'CONTEXTUAL'],
  ...
  releaseStage,
  safetyTier,
  completionKind: 'OUTPUT_VIEWED' as const,
  mode,
})));
