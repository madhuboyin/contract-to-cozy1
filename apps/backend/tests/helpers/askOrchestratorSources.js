...
// The orchestrator's own text comes first, then the support facade and modules, then the handler and execution files, sorted by path.
...
function readAskOrchestratorSources() {
  ...
  for (const dir of ['support', 'handlers', 'execution']) {
