...
// Side-effect import: askOrchestrator.service.ts registers its 82 handlers
...
test('every one of the 82 Ask operations resolves to a registered capability handler', () => {
