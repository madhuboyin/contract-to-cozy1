...
// Side-effect import: askOrchestrator.service.ts registers its 85 handlers
...
test('every one of the 85 Ask operations resolves to a registered capability handler', () => {
