...
// Side-effect import: askOrchestrator.service.ts registers its 73 handlers
...
test('every one of the 73 Ask operations resolves to a registered capability handler', () => {
  ...
  assert.equal(operationIds.length, 73);
