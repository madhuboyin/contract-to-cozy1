...
// Side-effect import: askOrchestrator.service.ts registers its 81 handlers
...
test('every one of the 81 Ask operations resolves to a registered capability handler', () => {
