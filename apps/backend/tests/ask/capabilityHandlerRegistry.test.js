...
// Side-effect import: askOrchestrator.service.ts registers its 74 handlers
...
test('every one of the 74 Ask operations resolves to a registered capability handler', () => {
  ...
  assert.equal(operationIds.length, 74);
