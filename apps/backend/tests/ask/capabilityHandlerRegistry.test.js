...
// Side-effect import: askOrchestrator.service.ts registers its 72 handlers
...
test('every one of the 72 Ask operations resolves to a registered capability handler', () => {
  ...
  assert.equal(operationIds.length, 72);
