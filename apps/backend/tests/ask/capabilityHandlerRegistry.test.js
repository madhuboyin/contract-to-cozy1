...
// Side-effect import: askOrchestrator.service.ts registers its 80 handlers
...
test('every one of the 80 Ask operations resolves to a registered capability handler', () => {
  ...
  // §8/§4.2; FRD §23).
  assert.equal(operationIds.length, 80);
