...
const TAXONOMY = Object.freeze({
  ...
  'property-record': ['PROPERTY_SUMMARY', 'INVENTORY_LOOKUP', 'HOME_CHANGE_SUMMARY', 'INVENTORY_ITEM_CORRECT', 'HOME_EVENT_CORRECT', 'WARRANTY_CORRECT', 'ROOM_RENAME', 'ROOM_CREATE', 'INVENTORY_ITEM_CREATE', 'PROPERTY_CONTEXT_AREA_CAPTURE', 'HOME_EVENT_VISIBILITY'],
